...
* Descri��o: Inicializa a estrutura que contem as listas de cada tipo de dado;
...
/**********************************************************************************************************************************
* Nome da fun��o: Le_Arquivo;
* Descri��o: Le o arquivo de entrada e insere os tipos de informa��es nas respectivas listas.
* Assertivas de Entrada: 
...
/**************************************************************************************************************************
* Nome da fun��o: Insere_Lista;
* Descri��o: Insere o tipo de informa��o lida, a partir da fun��o 'Le_arquivo', para o tipo correspondente das Listas.
* Assertivas de Entrada: 
*			char tipo_elemento;
*			Listas (previamente alocada, podendo ou n�o estarem vazias)
...
/*********************************************************************************************************************************
* Nome da fun��o: Imprime;
* Descri��o: Imprime a estrutura que armazena cada tipo de lista, ou seja, vai imprimir cada uma das listas de cidades, geradores,
...
* Descri��o: Desaloca a posi��o de mem�ria ocupada pelas listas.
* Assertivas de Entrada:
*			Listas criadas:
*			Listas->p_cidade != NULL;
*			Listas->p_gerador != NULL;
